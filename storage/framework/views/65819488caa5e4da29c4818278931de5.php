        ...
        <div class="row">
            ...
            <aside class="col-12 col-md-3 col-lg-2 bg-white border-end shadow-sm p-3 min-vh-100">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item mb-2">
                        <a href="<?php echo e(route('position')); ?>" class="nav-link text-dark">Jabatan</a>
                    </li>
                    <li class="nav-item mb-2">
...
</html><?php /**PATH D:\NASUHA ERZA\PWL\belajar_Laravel\resources\views/backend/dashboard/index.blade.php ENDPATH**/ ?>